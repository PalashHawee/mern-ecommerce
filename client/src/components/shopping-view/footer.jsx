...
const Footer = () => {
  return (
    <div>
      <footer className="relative py-20 flex flex-col items-center bg-purple-900 overflow-hidden md:py-40">
        <div className="relative z-[1] container m-auto px-6 md:px-12">
          <div className="m-auto md:w-10/12 lg:w-8/12 xl:w-6/12">
            <div className="flex flex-wrap items-center justify-between md:flex-nowrap">
              ...
              <div className="w-full space-y-8 text-gray-400 flex justify-center sm:w-5/12 md:justify-end">
                <p className="text-xl font-bold text-center sm:text-right sm:mr-4">
        ...
        <div className="w-full text-center py-4 mt-8 bg-gray-800 text-gray-300">
          <p className="text-sm">
